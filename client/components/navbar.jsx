  ...
  return (
    <div className="navbar bg-blue-950 text-white">
      <div className="flex-1">
        <Link href={'/'} className="btn btn-ghost text-2xl text-white font-extrabold">chare</Link>
      </div>
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            <div className="w-10 rounded-full bg-white p-3">
              <p className="text-center text-blue-950 capitalize">
                {email}
                </p>
            </div>
          </div>
          <ul
            tabIndex={0}
            className=" z-[1] p-2 shadow text-white menu menu-sm dropdown-content bg-base-100 rounded-box w-52"
          >
            <li className="pb-2">
